...
Route::get('migrate-seed', [API\CategoryController::class, 'MigrateFreshseed']);
Route::get('remove-session', [API\CommanController::class, 'RemoveSession']);
Route::get('set-location', [App\Http\Controllers\FrontendController::class, 'setLocation']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('provider-zones', [API\ProviderAddressMappingController::class, 'getProviderZones']);
    ...
    // Routes for Promotional Banner API
    Route::post('banner-payment', [API\PromotionalBannerController::class, 'apiSavePayment']);
    Route::post('save-banner', [API\PromotionalBannerController::class, 'savebanner']);
    Route::post('delete-banner/{id}', [API\PromotionalBannerController::class, 'destroyBanner']);
    Route::get('promotional-banner-list', [API\PromotionalBannerController::class, 'PromotionalBannerList']);
});
