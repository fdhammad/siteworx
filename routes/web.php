...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::group(['middleware' => ['permission:service list']], function () {
        ...
        Route::get('provider-service-request', [ServiceController::class, 'providerServiceRequest'])->name('service.provider-service-request');
        Route::get('request-index-data', [ServiceController::class, 'request_index_data'])->name('service.request-index-data');
    ...
    Route::post('promotion-config-save', [SettingController::class, 'promotionConfig'])->name('promotionConfig');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('promotional-banner/{id}', [PromotionalBannerController::class, 'destroy'])->name('promotional-banner.destroy');
    Route::post('promotional-banner/{id}/status', [PromotionalBannerController::class, 'updateStatus'])->name('promotional-banner.status');
    Route::get('promotional-banner/action/{id}/{type?}', [PromotionalBannerController::class, 'action'])->name('promotional-banner.action');
    Route::get('promotional-banner/{id}', [PromotionalBannerController::class, 'show'])->name('promotional-banner.show');
    Route::post('webhook', [PromotionalBannerController::class, 'handleStripeWebhook'])->name('promotional-banner.webhook');
    Route::post('promotional-banner/{banner_id}/payment', [PromotionalBannerController::class, 'processPayment']);
    Route::post('flutterwave/callback', [PromotionalBannerController::class, 'flutterwavehandleCallback'])->name('flutterwave.callback');
    Route::post('check-balance', [PromotionalBannerController::class, 'walletcheckBalance'])->name('wallet.check-balance');
    Route::post('process-payment', [PromotionalBannerController::class, 'walletprocessPayment'])->name('wallet.process-payment');
